...
This script replaces the standard Ubuntu 16.04 welcome message with a Helium logo and useful server information through modifying the MOTD files on the VPS. Tested on Vultr and DO. No lag. May work on other Ubuntu versions but maybe not.
